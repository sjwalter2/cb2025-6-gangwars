/// @function scr_get_gang_pathfinding_tiles(gang_name)
/// @desc Returns a ds_list of tile indices that can be traversed by the gang (includes friendly and adjacent unclaimed/enemy tiles)
...
function scr_get_gang_pathfinding_tiles(gang_name) {
    ...
    for (var i = 0; i < array_length(global.hex_grid); i++) {
        ...
        if (tile.owner == gang_name) {
            ...
            ds_map_add(visited_keys, key, true);
            ds_list_add(tiles, i);
